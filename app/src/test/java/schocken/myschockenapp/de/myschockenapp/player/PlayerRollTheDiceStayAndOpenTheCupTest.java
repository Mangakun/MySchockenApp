package schocken.myschockenapp.de.myschockenapp.player;//package de.schocken.marco.schocken_v1.player;
...
public class PlayerRollTheDiceStayAndOpenTheCupTest extends PlayerTest {
    /**
