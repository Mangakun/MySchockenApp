...
//        Player marco = spy(new PlayerImpl("Marco", (PlayerCallBack) observer,null));
//        Player michelle = spy(new PlayerImpl("Michelle", (PlayerCallBack) observer,null));
//        Player marei = spy(new PlayerImpl("Marei", (PlayerCallBack) observer,null));
//        List<Player> players = new ArrayList<>();
//        players.add(marco);
//        players.add(michelle);
//        players.add(marei);
//        when(playerCreator.createPlayers(ArgumentMatchers.any(String[].class),ArgumentMatchers.any(PlayerCallBack.class),null)).thenReturn(players);
//        try {
